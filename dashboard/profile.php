  ...
  <div class="row">
    ...
    padding: 42px 0;">
                  ...
                  <div class="card-body text-center"  >
                    ...
                    <img id="p_img" src="<?php $auth_user->getUserPic();?>" alt="Profile Image"  runat="server"  height="125" width="125" class="rounded-circle" style="border:1px solid; border-color:#383d41;"/>
                    </div>
                    ...
                    <table class="table table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th scope="row">Sex:</th>
                          <td><?php  $auth_user->profile_sex()?></td>
                        </tr>
                        <tr>
                          <th scope="row">Birth Date:</th>
                          <td id="pro-dob"><?php  $auth_user->profile_dob()?></td>
                          <th scope="row">Age:</th>
                          <td id="pro-age"><?php  $auth_user->profile_age()?></td>
                        </tr>
                        <tr>
        ...
        <form id="change_password_form" enctype="multipart/form-data">
          ...
          <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="password" class="form-control" id="update_password_new" name="update_password_new" placeholder="" value="" minlength="6" required="">
              </div>
            </div>
          <div class="form-row">
              <div class="form-group col-md-12">
                  <label for="update_password_newconfirm">Confirm Password</label>
                <input type="password" class="form-control" id="update_password_newconfirm" name="update_password_newconfirm" placeholder="" value="" minlength="6" required="">
              </div>
            </div>
      </div>
      <div class="modal-footer">
